...
/* Task 2: Corporate has come to you with an idea for a new flavor: Rainbow Sherbert! You need to modify the array to include this flavor. 
...
// to ask Chris: 'Rainbow Sherbert' is inserted wherever it says 'Flavor', why can't you just write 'array' at the begining of .unshift?
...
/* Task 3: Your task is to remove an item from the end of the array. 
...
// josh did a loop, is that better? and why?
...
/* Task 6: Write a function called copy that makes a copy of the array. 
...
let newArr = copy(originalFlavors)

console.log(newArr)



// console.log(originalFlavors) ------ this is just to see if the original array still works

/* Task 7: create promotional materials highlighting all of their chocolate flavors. 
...
consule.log(filterByWord(originalFlavors, 'chocolate'))
